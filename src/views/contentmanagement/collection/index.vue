	...
	<KQueryList>
		<KQueryTable>
			<KTableBar title="收藏" :columns="columns" @refresh="fetchData">
				<template #buttons>
					<el-button
						v-access="'contentmanagement:collection:add'"
						type="primary"
				...
				<template #default="{ size, dynamicColumns }">
					...
					>
						<template #operation="{ row }">
							<el-button
								v-access="'contentmanagement:collection:edit'"
								class="!m-0"
								link
								type="primary"
								:size="size"
							...
							<el-button
								v-access="'contentmanagement:collection:del'"
								class="!m-0"
								link
								type="danger"
								:size="size"
...
const {
	...
	hasPermission: () => access.hasAccess("contentmanagement:collection:detail"),
})
const columns = [
	{
		label: "",
